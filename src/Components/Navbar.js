...
const Navbar = ({ darkMode, setDarkMode }) => {
  ...
  return (
  <nav className={`w-full flex items-center justify-between px-6 py-3 shadow-sm transition-colors duration-300 ${darkMode ? "bg-[#181824] text-[#F3F3F3] border-b border-[#23272F]" : "bg-white text-gray-900"}`}> 
      {/* Logo */}
