    ...
    <div style={{ backgroundColor: "rgb(249,250,251)", padding: "20px"}}>
      ...
      <div className="about-me-main">
        ...
        <div className="about-me-right">
          ...
          I’m <b>a final Computer Science student at KiiT University, Bhubaneshwar,</b> diving deep into the world of web development. Every day, I push myself to learn, build, and refine my skills—whether it's through personal projects, working with startups, or just tinkering with new tech. Since starting my journey, I’ve worked with <b>HTML, CSS, JavaScript, React, Supabase, and more,</b> and while I’m still a beginner, I love the process of learning, experimenting, and improving. <br></br><br></br>
