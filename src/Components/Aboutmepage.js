...
const Aboutmepage = ({ darkMode }) => {
  return (
  <div id="about_section" className={`py-8 px-4 font-sans min-h-screen transition-colors duration-300 ${darkMode ? "bg-[#111827] text-[#F3F3F3]" : "bg-gray-50 text-gray-900"}`}>
